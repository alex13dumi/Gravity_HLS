...
#define AUTOTB_TVOUT_distance "../tv/cdatafile/c.gravity.autotvout_distance.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_distance "../tv/rtldatafile/rtl.gravity.autotvout_distance.dat"
...
extern "C" float apatb_gravity_hw(float __xlx_apatb_param_m1, float __xlx_apatb_param_m2, float __xlx_apatb_param_distance) {
...
aesl_fh.touch(AUTOTB_TVOUT_distance);
...
// print distance Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_distance, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_distance);
...
float ap_return = gravity_hw_stub_wrapper(__xlx_apatb_param_m1, __xlx_apatb_param_m2, __xlx_apatb_param_distance);
