...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "F:/Vivado/Vitis_HLS/2020.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h" 1
# 158 "F:/Vivado/Vitis_HLS/2020.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
extern "C" {
...
# 2 "<built-in>" 2
# 1 "core.cpp" 2
__attribute__((sdx_kernel("gravity", 0))) float gravity(float m1, float m2, float distance)
{
